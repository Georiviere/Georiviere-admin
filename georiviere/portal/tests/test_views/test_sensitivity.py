...
class SensitivityViewTest(TestCase):
    ...
    def test_sensitivity_detail_json_structure(self):
        ...
        self.assertSetEqual(set(response.json().keys()), {'id', 'species', 'description', 'contact', 'attachments'})
    ...
    def test_sensitivity_list_json_structure(self):
        ...
        self.assertSetEqual(set(response.json()[0].keys()), {'id', 'species', 'description', 'contact', 'attachments'})
