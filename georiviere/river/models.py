...
Stream.add_property('followups', FollowUp.within_buffer, _("Followups"))
Stream.add_property('followups_without_knowledges', FollowUp.within_buffer_without_knowledge, _("Followups"))
