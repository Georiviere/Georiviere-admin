# Generated by Django 3.1.14 on 2023-05-17 13:44
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('type_label', models.CharField(blank=True, max_length=128, verbose_name='First list label')),
            ],
            options={
        ...
        migrations.CreateModel(
            name='ContributionPotentialDamageType',
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('label', models.CharField(max_length=128, verbose_name='Label')),
            ],
