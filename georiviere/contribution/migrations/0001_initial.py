# Generated by Django 3.1.14 on 2023-05-25 15:44
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('contribution', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, parent_link=True, related_name='landscape_elements', to='contribution.contribution')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('water_level_type', models.IntegerField(choices=[(1, 'Dry'), (2, 'In the process of drying out'), (3, 'Overflow')], default=1, verbose_name='Water level type')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('quality_water_type', models.IntegerField(choices=[(1, 'Algal development'), (2, 'Pollution'), (3, 'Water temperature')], default=1, verbose_name='Quality water type')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('heritage_observations', models.ForeignKey(null=True, on_delete=django.db.models.deletion.PROTECT, to='contribution.heritageobservation')),
