...
MAPENTITY_CONFIG = {
    ...
    'MAP_STYLES': {
        ...
        'usage': {'weight': 4, 'color': '#F88017', 'opacity': 0.7},
        'morphology': {'weight': 4, 'color': 'brown', 'opacity': 0.7},
        'status': {'weight': 4, 'color': 'grey', 'opacity': 0.7},
        'land': {'weight': 4, 'color': 'red', 'opacity': 0.7},
        'stream': {'weight': 4, 'color': 'blue', 'opacity': 0.7},
        'knowledge': {'weight': 4, 'color': '#198754', 'opacity': 0.7},
        'followup': {'weight': 4, 'color': '#fd7e14', 'opacity': 0.7},
        'intervention': {'weight': 4, 'color': '#fd7e14', 'opacity': 0.7},
        'station': {'weight': 4, 'color': '#FFD801', 'opacity': 0.7},
        'study': {'weight': 4, 'color': '#d63384', 'opacity': 0.7},
        'proceeding': {'weight': 4, 'color': '#3dd5f3', 'opacity': 0.7},
    }
}
